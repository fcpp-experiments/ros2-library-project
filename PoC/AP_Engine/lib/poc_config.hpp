...
const int DEFAULT_WEARABLE_COUNT            = 0;
...
const string AP_ROBOT_FAIL_TIMEOUT_SEC_KEY  = "AP_ROBOT_FAIL_TIMEOUT_SEC";
...
const int ROBOT_FAIL_TIMEOUT_SEC            = read_int_env(AP_ROBOT_FAIL_TIMEOUT_SEC_KEY, DEFAULT_ROBOT_FAIL_TIMEOUT_SEC);
