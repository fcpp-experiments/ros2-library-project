...
const string AP_STOP_EXITING_GOAL_TIMEOUT_SEC_KEY   = "AP_STOP_EXITING_GOAL_TIMEOUT_SEC";
const int DEFAULT_STOP_EXITING_GOAL_TIMEOUT_SEC     = 2;
...
const int AP_STOP_EXITING_GOAL_TIMEOUT_SEC          = read_int_env(AP_STOP_EXITING_GOAL_TIMEOUT_SEC_KEY, DEFAULT_STOP_EXITING_GOAL_TIMEOUT_SEC);
